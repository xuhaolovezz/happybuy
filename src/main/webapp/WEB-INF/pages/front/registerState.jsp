...
<html>
	...
	<input type="hidden" id="basePath" value="${pageContext.request.contextPath}">
		...
		<div class="container">
			<div style="margin: 50px auto; font-size: 24px; font-weight: bold;line-height: 40px">
				${activeState}<br>
				<span id="time">5</span>秒后跳转到<a href="${pageContext.request.contextPath}/login.jsp">登录</a>界面
			</div>
		</div>	
