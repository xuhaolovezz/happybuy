...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/common/bootstrap-datepicker3.css">
		...
		<script src="${pageContext.request.contextPath}/resources/js/common/bootstrap-datepicker.js"></script>
		<script src="${pageContext.request.contextPath}/resources/js/common/bootstrap-datepicker.zh-CN.js"></script>
		...
		<div class="container">
			<div class="ic">
				<div class="c-left">
					...
					<p><a href="${pageContext.request.contextPath}/user/modify" class="a-selected">账户信息</a></p>
					...
					<div class="message">
						...
						<div class="message-text">
							<div class="message-left">
								<span class="span-message">账号：</span><br>
								<span class="span-message">昵称：</span><br>
								<span class="span-message">手机号：</span><br>
								<span class="span-message">邮箱：</span><br>
								<span class="span-message">性别：</span><br>
								<span class="span-message">生日：</span><br>
							</div>
							<div class="message-right">
								<form id="form-update-user">
								<span class="span-message">${user.username}</span><br>
								...
								<span class="span-message">${user.email}</span><br>
									男&nbsp;<input type="radio" name="gender" <c:if test="${user.gender==1}">checked</c:if> value="1">
								<span style="margin-left: 20px">女</span>&nbsp;<input type="radio" <c:if test="${user.gender==2}">checked</c:if>  name="gender" value="2"><br>
								<input type="text" name="birthday" value="<fmt:formatDate value="${user.birthday}" type="date" />" class="form-control datepicker"><br>
								</form>
							</div>
