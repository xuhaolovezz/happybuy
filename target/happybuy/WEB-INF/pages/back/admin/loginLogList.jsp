...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/back/admin/loginLogList.js"></script>
    <script type="text/javascript">
        $(function () {
            var currPage =${requestScope.loginLogPageBean.currPage};
            if( currPage == '1'){
            ...
            if(currPage == "${requestScope.loginLogPageBean.totalPage}"){
            ...
            //循环输出页码
            if("${loginLogPageBean.totalPage}" <=6){
                for(var i = 1; i <= ${loginLogPageBean.totalPage}; i ++){
                    $(".page-next").before("<li class='li-page'>" +
                        "<a href='${pageContext.request.contextPath}/admin/loginLogList/"+i+"'>"
                        + i + "</a>" +
                        "</li>");
                }
            } else {
                if(currPage >= 4){
                    for( var j = currPage - 3; j <= currPage+3 && j<=${loginLogPageBean.totalPage}; j++){
                        $(".page-next").before("<li class='li-page'>" +
                            "<a href='${pageContext.request.contextPath}/admin/loginLogList/"+j+"'>"
                            + j + "</a>" +
                            "</li>");
                    }
                    ...
                    for(var k = 1; k <= 6; k ++){
                        $(".page-next").before("<li class='li-page'>" +
                            "<a href='${pageContext.request.contextPath}/admin/loginLogList/"+k+"'>"
                            + k + "</a>" +
                            "</li>");
                    }
                }
...
<div class="container-fluid">
	...
	<div class="col-md-9 col-xs-offset-2 nav-right">
		...
		<table class="table table-bordered table-responsive table-hover text-center">
			...
			<c:forEach items="${loginLogPageBean.list}" var="item" varStatus="i">
                <tr >
					<td value="${item.id}">
		...
		<div class="col-xs-offset-4">
			<ul class="pagination">
				<li class="li-page">
					<a id="firstPage" href="${pageContext.request.contextPath}/admin/loginLogList/1">首页</a>
				</li>
				<li class="li-page">
					<a href="${pageContext.request.contextPath}/admin/loginLogList/${requestScope.loginLogPageBean.currPage-1}"
					   id="prevPage">&laquo; 上一页</a>
				</li>
				<%--<li class="li-page">
					<a href="${pageContext.request.contextPath}/admin/loginLogList/1">1</a>
				</li>--%>
				...
				<li class="li-page">
					<a id="lastPage"  href="${pageContext.request.contextPath}/admin/loginLogList/${requestScope.loginLogPageBean.totalPage}">尾页</a>
				</li>
				<li style="cursor: default">
                        <span>当前第 <span>${requestScope.loginLogPageBean.currPage} / ${requestScope.loginLogPageBean.totalPage} 页</span>&nbsp;
                        共 ${requestScope.loginLogPageBean.totalSize} 条记录
                            </span>
				</li>
			</ul>
		</div>
